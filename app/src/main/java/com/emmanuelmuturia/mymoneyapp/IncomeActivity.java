...
public class IncomeActivity extends AppCompatActivity {
    ...
    private com.emmanuelmuturia.mymoneyapp.IncomeAdapter incomeAdapter;
            ...
            public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.categories:
                        Intent intent = new Intent(IncomeActivity.this, com.emmanuelmuturia.mymoneyapp.CategoryActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            ...
            mAuth.signOut();
            Intent intent = new Intent(IncomeActivity.this, com.emmanuelmuturia.mymoneyapp.LoginActivity.class);
            startActivity(intent);
        }
    ...
    public void fab(View view) {
        Intent intent = new Intent(IncomeActivity.this, com.emmanuelmuturia.mymoneyapp.IncomeExpenseActivity.class);
        startActivity(intent);
    }
}